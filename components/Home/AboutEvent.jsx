        ...
        <div className="flex flex-col-reverse md:flex-row items-center gap-x-16 gap-y-8">
          ...
          <div className="w-full ">
            <p className="text-center text-base sm:text-lg text-gray-600 max-w-xl">
              ...
              Taking place on October 18 and 19, 2022, at Millennium Hall in
              Addis Ababa, this expo will provide a platform for job seekers to
              explore various job sectors, network with employers, and enhance
              their employability and career development.
            </p>
          </div>
        </div>
      </AnimationOnScroll>
